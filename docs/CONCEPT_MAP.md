# DataPulse Guardian - staj kılavuzu kavram haritası

Bu belge, kılavuzdaki başlıkların DataPulse Guardian içinde nasıl gösterileceğini izler.

| Kılavuz terimi | DataPulse Guardian karşılığı | Durum |
|---|---|---|
| Scrum, Agile | Tarihli iş günü yol haritası, günlük stand-up ve backlog | Uygulandı |
| Node.js, ExpressJS | REST API ve sunucu katmanı | Uygulandı |
| .NET Core | Express katmanlarının .NET Core Web API karşılaştırma notu | Belgelendi |
| Vue.js, HTML, CSS | Responsive görev panosu | Uygulandı |
| RDBMS | SQLite görev veritabanı | Uygulandı |
| NoSQL | JSON profil belgeleri ve append-only olay deposu | Uygulandı |
...
| HTTP Request | Vue API istemcisi ve sunucu uçları | Uygulandı |
| REST | Kaynak, kalite özeti ve sürümlü veri sözleşmesi uçları | Uygulandı |
| SOAP | XML kaynak alımı ve SOAP uyumluluk sınırı mimari notu | Belgelendi |
| JSON | Varsayılan API veri biçimi ve sözleşme alan tanımı | Uygulandı |
| XML | XML kayıt ayrıştırma, profil çıkarma ve doğrulama | Uygulandı |
| ORM | Repository/data mapper ve code-first yaklaşım karşılaştırması | Uygulandı |
